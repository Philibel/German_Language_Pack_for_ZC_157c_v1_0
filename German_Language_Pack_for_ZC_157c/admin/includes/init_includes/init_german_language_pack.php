 ...
 * @version 1.5.7.1.0
 * @author Zen4All with minor adaptions for the German version 1.0 for Zen Cart 1.5.7c by Benny Philibel
 ...
 */
 ...
 $module_constant = 'GERMAN_LANGUAGE_PACK_VERSION';
 $module_installer_directory = DIR_FS_ADMIN . 'includes/installers/german_language_pack';
 $module_name = 'German Language Pack';
 $module_file_for_version_check = '';
 $zencart_com_plugin_id = 205;
