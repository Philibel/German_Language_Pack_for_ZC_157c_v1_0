 ...
 * @version $Id: german translation 2021-05-12 Benny Philibel Modified in v1.5.7a $
 */
  ...
  define('TEXT_ALL_FILES_LOOKUP_ALL_TYPES', 'Alle Dateien');

  define('TEXT_CASE_SENSITIVE', 'Groß-/Kleinschreibung beachten?');
  define('TEXT_CONTEXT_LINES', 'Kontextzeilen: ');
  define('TEXT_SEARCH_LOOKUP_PLACEHOLDER', 'Geben Sie einen Suchbegriff oder ein Suchmuster ein');
  define('TEXT_SEARCH_KEY_PLACEHOLDER', 'Geben Sie den Schlüsselnamen oder die Phrase ein, nach der gesucht werden soll');
  ...
  define('TEXT_BUTTON_REGEX_SEARCH_ALT', 'Suche mit Regex-Muster');
  define('TEXT_ERROR_REGEX_FAIL', 'ALERT: Bei der Suche ist ein Fehler aufgetreten. Wenn Sie eine Regex/Grep-Suche durchgeführt haben, überprüfen Sie Ihr Regex-Muster auf Syntaxfehler.');
  ...
  define('TEXT_RESET_BUTTON_ALT', 'Alles zurücksetzen und neu beginnen.');
