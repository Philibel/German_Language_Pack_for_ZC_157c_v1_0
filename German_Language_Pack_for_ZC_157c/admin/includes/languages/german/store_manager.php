 ...
 */
  ...
  define('SUCCESS_PRODUCT_UPDATE_PRODUCTS_PRICE_SORTER', 'Die Sortierung der Artikelpreise wurden <strong>erfolgreich</strong> aktualisiert');
  define('SUCCESS_PRODUCT_UPDATE_PRODUCTS_VIEWED', 'Die besuchten Artikel wurden <strong>erfolgreich</strong> auf 0 zurückgesetzt');
  define('SUCCESS_PRODUCT_UPDATE_PRODUCTS_ORDERED', 'Die gekauften Artikel wurden erfolgreich auf 0 zurückgesetzt');
  ...
  define('TEXT_INFO_PRODUCTS_ORDERED_UPDATE', '<strong>ALLE gekauften Artikel zurücksetzen</strong><br />Anzahl bestellter Artikel auf 0 setzen: ');
