...
define('HEADING_TITLE_MODULES_ORDER_TOTAL', 'Bestellungzusammenfassung');
...
define('TEXT_WARNING_SSL_EDIT', 'ALERT: <a href="https://docs.zen-cart.com/user/installing/enable_ssl/" rel="noopener" target="_blank">Aus Sicherheitsgründen ist die Bearbeitung dieses Moduls deaktiviert, bis Ihr Administrator für SSL konfiguriert ist</a>.');
define('TEXT_WARNING_SSL_INSTALL', 'ALERT: <a href="https://docs.zen-cart.com/user/installing/enable_ssl/" rel="noopener" target="_blank">Aus Sicherheitsgründen ist die Installation dieses Moduls deaktiviert, bis Ihr Administrator für SSL konfiguriert ist</a>.');

// Generic validation messages for modules
define('TEXT_POSITIVE_INT','%s muss eine ganze Zahl größer oder gleich 0 sein');
define('TEXT_POSITIVE_FLOAT','%s muss eine Dezimalstelle größer oder gleich 0 sein');
