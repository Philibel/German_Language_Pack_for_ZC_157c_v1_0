...
define('HEADING_TITLE_DETAILS', 'Bestelldetails (#%u)');     //-%u is filled in with the actual order-number
define('HEADING_TITLE_SEARCH', 'Bestell ID:');
define('HEADING_TITLE_STATUS', 'Status: ');
define('HEADING_TITLE_SEARCH_DETAIL_ORDERS_PRODUCTS', 'Suche nach Artikelname oder <strong>ID:XX</strong> oder Modell');
...
define('TEXT_INFO_RESTOCK_PRODUCT_QUANTITY', 'Artikelmenge auffüllen');
...
define('EMAIL_TEXT_COMMENTS_UPDATE', '<em>Die Kommentare für Ihre Bestellung lauten: </em>');
...
define('TEXT_DOWNLOAD_MAX_COUNT', 'Anzahl');
...
define('TEXT_EXTENSION_NOT_UNDERSTOOD', 'Dateierweiterung %s wird nicht unterstützt'); 
...
define('SUCCESS_ORDER_UPDATED_DOWNLOAD_ON', 'Der Download wurde erfolgreich aktiviert');
define('SUCCESS_ORDER_UPDATED_DOWNLOAD_OFF', 'Der Download wurde erfolgreich deaktiviert');
...
define('TEXT_CUSTOMER_LOOKUP', '<i class="fa fa-search"></i> Kunden suchen');

define('TEXT_INVALID_ORDER_STATUS', '<span class="alert">(Ungültiger Bestellstatus)</span>');

define('BUTTON_TO_LIST', 'Bestellungsliste');
define('SELECT_ORDER_LIST', 'gehe zur Bestellung: ');

define('TEXT_MAP_CUSTOMER_ADDRESS', 'Karte Kundenadresse');
define('TEXT_MAP_SHIPPING_ADDRESS', 'Karte Versandadresse');
define('TEXT_MAP_BILLING_ADDRESS', 'Karten Abrechnungsadresse');

define('TEXT_EMAIL_LANGUAGE', 'Bestellsprache: %s');
define('SUCCESS_EMAIL_SENT', 'Email %s an Kunden gesendet');
