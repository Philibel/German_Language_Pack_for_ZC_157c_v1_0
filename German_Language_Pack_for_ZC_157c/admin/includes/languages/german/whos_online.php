...
define('TEXT_SESSION_ID', '<strong>Sitzungs-ID:</strong>');
define('TEXT_HOST', '<strong>Host:</strong> ');
define('TEXT_USER_AGENT', '<strong>User Agent:</strong> ');
define('TEXT_EMPTY_CART', '<strong>Leerer Einkaufswagen</strong>');
define('TEXT_WHOS_ONLINE_FILTER_SPIDERS', 'Spiders ausschließen?');
define('TEXT_WHOS_ONLINE_FILTER_ADMINS', 'Administrator-IP-Adressen ausschließen?');
...
define('TEXT_TOTAL_UNIQUE_USERS', 'Insgesamt eindeutige Benutzer: ');

define('TEXT_WHOS_ONLINE_TIMER_UPDATING', 'Aktualisierung ');
define('TEXT_WHOS_ONLINE_TIMER_EVERY', 'jedes %s Sekunden.&nbsp;&nbsp;');
define('TEXT_WHOS_ONLINE_TIMER_DISABLED', 'Manuell');
define('TEXT_WHOS_ONLINE_TIMER_FREQ0', 'AUS');
define('TEXT_WHOS_ONLINE_TIMER_FREQ1', '5 s');
define('TEXT_WHOS_ONLINE_TIMER_FREQ2', '15 s');
define('TEXT_WHOS_ONLINE_TIMER_FREQ3', '30 s');
