...
define('ATTRIBUTE_WARNING_DUPLICATE', 'Hinzufügen nicht möglich - Attribut ist bereits vorhanden'); // attributes duplicate warning
define('ATTRIBUTE_WARNING_DUPLICATE_UPDATE', 'Änderung nicht möglich - Attribut ist bereits vorhanden'); // attributes duplicate warning
define('ATTRIBUTE_WARNING_INVALID_MATCH', 'Attribut konnte nicht erstellt werden - Attributoption und Attributmerkmal stimmen nicht überein'); // miss matched option and options value
define('ATTRIBUTE_WARNING_INVALID_MATCH_UPDATE', 'Attribut konnte nicht geändert werden - Attributoption und Attributmerkmal stimmen nicht überein'); // miss matched option and options value
define('ATTRIBUTE_POSSIBLE_OPTIONS_NAME_WARNING_DUPLICATE', 'Möglicherweise wurde ein doppelter Attributname hinzugefügt'); // Options Name Duplicate warning
define('ATTRIBUTE_POSSIBLE_OPTIONS_VALUE_WARNING_DUPLICATE', 'Möglicherweise wurde ein doppeltes Attributmerkmal hinzugefügt'); // Options Value Duplicate warning

define('PRODUCTS_ATTRIBUTES_EDITING', 'BEARBEITEN'); // title
define('PRODUCTS_ATTRIBUTES_DELETE', 'LÖSCHEN'); // title
...
define('TEXT_INFO_OPTION_VALUE_COPY_OPTIONS_TO', 'Selektieren Sie einen Optionsnamen und Wert der aktuell einem Artikel/Artikeln zugeordnet ist, damit sie diese Information einer Kategorie od. allen Artikeln zuweisen können die einen bestimmten Optionsnamen besitzen.
...
define('LABEL_FILTER', 'Wählen Sie den zu filternden Optionswert');
define('TEXT_DISPLAY_NUMBER_OF_OPTION_VALUES', 'Anzeigen von <b>%d</b> bis <b>%d</b> (von <b>%d</b> Optionswerten)');
