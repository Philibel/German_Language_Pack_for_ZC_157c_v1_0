...
define('TEXT_PRICE_NET', 'Preis (Netto)');
define('TEXT_PRICE_GROSS', 'Preis (Brutto)');
...
define('TEXT_SPECIALS_SPECIAL_PRICE_NET', 'Sonderpreis: (Netto)');
define('TEXT_SPECIALS_SPECIAL_PRICE_GROSS', 'Sonderpreis: (Brutto)');
...
define('BUTTON_ADDITIONAL_ACTIONS', 'Zusätzliche Aktionen');
