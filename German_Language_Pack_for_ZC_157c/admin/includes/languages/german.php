 ...
 * @version $Id: german translation 2021-05-15 Benny Philibel Modified in v1.5.7 $
 */
...
define('HEADER_ALT_TEXT', 'Admin powered by Zen-Cart 1.5.7 - German Translation');
...
define('TEXT_DISPLAY_NUMBER_OF_GENERIC', 'Zeige <b>%d</b> bis <b>%d</b> (von <b>%d</b> Einträge)');
...
define('ERROR_FILE_NOT_REMOVEABLE', 'FEHLER: Die angegebene Datei konnte nicht gelöscht werden. Sie müssen diese Datei manuell per FTP löschen aufgrund einer Konfigurationsbeschränkung für Serverberechtigungen.');
...
define('TEXT_VERSION_CHECK_CURRENT', 'Sie verwenden die neueste Version von Zen Cart&reg;.');
...
define('ERROR_USPS_STATUS', '<strong>Warnung:</strong> Bei USPS fehlt entweder der Benutzername und/oder das Passwort, oder ... ist auf TEST gesetzt und arbeitet nicht im PRODUKTIONSMODUS<br>Wenn Sie weiterhin keine Werte erhalten, kontaktieren Sie bitte USPS und aktivieren dort Ihren Account. 1-800-344-7779 or icustomercare@usps.com');
...
define('TEXT_CATEGORIES_PRODUCTS', 'Wählen Sie eine Kategorie mit Artikel (durch ein Sternchen gekennzeichnet) / zwischen den Artikeln wechseln');
...
define('ERROR_EDITORS_FOLDER_NOT_FOUND', 'Sie haben den internen HTML-Editor vorgewählt in Konfiguration -> Mein Shop. Der Ordner \'/editors/\' kann nicht lokalisiert werden. Bitte prüfen Sie, ob der Ordner verschoben wurde oder deaktivieren Sie die getroffene Einstellung  \''.DIR_WS_CATALOG.'editor/\' Ordner');

define('TEXT_PRODUCT_POPUP_BUTTON', '<i class="fa fa-commenting"></i>');
define('TEXT_PRODUCT_POPUP_TITLE', 'Bestellte Artikel');

define('TEXT_CATEGORIES_PRODUCTS_SORT_ORDER_INFO', 'Kategorien/Artikelsortierung: ');
...
define('WARNING_ATTRIBUTE_COPY_SAME_ID', 'Warnung: Attributkopie abgebrochen. Kopieren von Artikel ID#%u in Artikel ID#%u (gleiche ID) nicht möglich.');
define('WARNING_ATTRIBUTE_COPY_NO_ATTRIBUTES', 'Warnung: Attributkopie abgebrochen. Keine Attribute für Quellartikel ID#%u, "%s" gefunden.');
define('WARNING_ATTRIBUTE_COPY_INVALID_ID', 'Warnung: Attributkopie in Artikel ID#%u abgebrochen. Ungültige ID');
define('TEXT_ATTRIBUTE_COPY_SKIPPING', 'Attribut ID#%u für Artikel ID#%u überspringen');
define('TEXT_ATTRIBUTE_COPY_INSERTING', 'Attribut ID#%u von Artikel ID#%u in Artikel ID#%u kopiert');
...
define('WARNING_EMAIL_SYSTEM_DEVELOPER_OVERRIDE', 'WARNUNG: Das Senden von E-Mails wurde deaktiviert, da der Entwicklerschalter "DEVELOPER_OVERRIDE_EMAIL_STATUS" auf "false" gesetzt ist.');
define('WARNING_EMAIL_SYSTEM_DEVELOPER_EMAIL', 'WARNUNG: ALLE E-Mails werden an %s gesendet (wie in "DEVELOPER_OVERRIDE_EMAIL_ADDRESS" definiert).');
...
define('ERROR_DATABASE_MAINTENANCE_NEEDED', '<a href="https://docs.zen-cart.com/user/troubleshooting/error_71_maintenance_required/" rel="noopener" target="_blank">FEHLER 0071: Es scheint ein Problem mit der Datenbank zu geben. Ausführung von Datenbankwartungsfunktionen ist erforderlich.</a>');
...
define('MENU_CATEGORIES_TO_SORT_BY_NAME','Berichte, Tools'); 

// Plugins
define('PLUGIN_INSTALL_SQL_FAILURE', 'Ein oder mehrere Datenbankfehler sind aufgetreten');

// ARIA Stuff

define('ARIA_PAGINATION_ROLE_LABEL_GENERAL', 'Paginierung');
define('ARIA_PAGINATION_ROLE_LABEL_FOR', '%s Paginierung'); // eg: "Search results Pagination"
define('ARIA_PAGINATION_PREVIOUS_PAGE', 'Zur vorherigen Seite gehen');
...
define('ARIA_PAGINATION_ELLIPSIS_PREVIOUS', 'Vorherige Seitengruppe abrufen');
define('ARIA_PAGINATION_ELLIPSIS_NEXT', 'Nächste Seitengruppe abrufen');
