 ...
 * @version $Id: german translation 2021-05-05 Benny Philibel Modified in v1.5.7 $
 */
  ...
  define('MODULE_PAYMENT_PAYPALWPP_TEXT_PAYPAL_DECLINED', 'Entschuldigung. PayPal hat die Transaktion abgelehnt und hat uns geraten Ihnen zu sagen sich zu wenden an den PayPal-Kundendienst, um weitere Informationen zu erhalten. Um Ihren Kauf abzuschließen, wählen Sie bitte eine alternative Zahlungsmethode.');
  ...
  define('MODULE_PAYMENT_PAYPALWPP_FUNDING_ERROR','Finanzierungsquellenproblem; Bitte gehen Sie zu Paypal.com und leisten Sie die Zahlung direkt an ' . STORE_OWNER_EMAIL_ADDRESS);
...
///// You should only use choices listed on this page: https://developer.paypal.com/docs/classic/api/buttons/ or https://www.paypal-techsupport.com/app/answers/detail/a_id/632
  define('MODULE_PAYMENT_PAYPALWPP_EC_BUTTON_IMG', 'https://www.paypalobjects.com/de_DE/i/btn/btn_xpressCheckout.gif'); // 145x42 Express-Kauf mit PayPal
  //define('MODULE_PAYMENT_PAYPALWPP_EC_BUTTON_IMG', 'https://www.paypalobjects.com/webstatic/de_DE/btn/btn_checkout_pp_142x27.png'); // Dieser Link funktioniert am 5. Mai 2021 nicht.
  define('MODULE_PAYMENT_PAYPALWPP_EC_BUTTON_SM_IMG', 'https://www.paypalobjects.com/de_DE/i/btn/btn_xpressCheckoutsm.gif'); // 145x42 Express-Kauf mit PayPal Schnell, einfach, sicher
  ...
  //define('MODULE_PAYMENT_PAYPALEC_MARK_BUTTON_IMG', 'https://www.paypalobjects.com/de_DE/i/logo/PayPal_mark_37x23.gif');  // 37x23 Logo PayPal
  //define('MODULE_PAYMENT_PAYPALEC_MARK_BUTTON_IMG', 'https://www.paypalobjects.com/de_DE/i/logo/PayPal_mark_50x34.gif');  // 50x34 Logo PayPal
  //define('MODULE_PAYMENT_PAYPALEC_MARK_BUTTON_IMG', 'https://www.paypalobjects.com/de_DE/i/bnr/horizontal_solution_PP.gif'); // 440x42 Logo PayPal und Karten
  //define('MODULE_PAYMENT_PAYPALEC_MARK_BUTTON_IMG', 'https://www.paypalobjects.com/de_DE/i/bnr/horizontal_solution_PPeCheck.gif'); // Dieser Link funktioniert am 5. Mai 2021 nicht.
  define('MODULE_PAYMENT_PAYPALEC_MARK_BUTTON_IMG', 'https://www.paypalobjects.com/de_DE/i/btn/btn1_for_hub.gif'); // 440x42 Kaufabwicklung mit PayPal
...
// this text is used to announce the username/password when the module creates the customer account and emails data to them:
  ...
  define('MODULES_PAYMENT_PAYPALDP_TEXT_EMAIL_FMF_INTRO', 'Dies ist eine automatische Benachrichtigung, die Sie darüber informiert, dass PayPal die Zahlung für eine neue Bestellung als Zahlungsüberprüfung durch das Betrugsteam gekennzeichnet hat. Normalerweise ist die Überprüfung innerhalb von 36 Stunden abgeschlossen. Es wird DRINGEND EMFOHLEN, dass Sie den Auftrag NICHT VERSENDEN bis zur Zahlung Überprüfung abgeschlossen ist. Sie können den aktuellen Überprüfungsstatus der Bestellung anzeigen, indem Sie sich bei Ihrem PayPal-Konto anmelden und die letzten Transaktionen überprüfen.');
