...
define('BUTTON_CONTACT_US_TEXT', 'Kontaktiere uns');
...
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Detaillierte Artikelbeschreibung');
define('BUTTON_MORE_REVIEWS_ALT', 'Weitere Bewertungen');
define('BUTTON_VIEW_ALL_ALT', 'Alle ansehen');
define('BUTTON_ASK_A_QUESTION_ALT', 'Stelle eine Frage');
