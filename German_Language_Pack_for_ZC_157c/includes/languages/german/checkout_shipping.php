 ...
 * @version $Id: german translation 2021-05-02 Benny Philibel $
 */
...
define('TEXT_CHOOSE_SHIPPING_DESTINATION', 'Ihre Bestellung wird an die links angezeigte Anschrift geliefert oder Sie können die Lieferanschrift ändern, wenn Sie auf den Button <em>Adresse ändern</em> klicken.');
...
define('TABLE_HEADING_COMMENTS', 'Besondere Anweisungen oder Kommentare zu Ihrer Bestellung');
