...
define('TEXT_SEE_ORDERS', 'Sie können Ihre Bestellhistorie unter <a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">Mein Konto</a> Seite ansehen und indem Sie auf "Alle Bestellungen anzeigen" klicken.');
