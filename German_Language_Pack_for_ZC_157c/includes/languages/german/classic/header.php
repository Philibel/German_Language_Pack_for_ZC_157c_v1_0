 ...
 * @version $Id: german translation 2021-04-30 Benny Philibel Modified in v1.5.7 $
 */
...
define('HEADER_SALES_TEXT', '<h1>Hier den Werbespruch eintragen</h1>');
...
define('SEARCH_DEFAULT_TEXT', 'Suchen hier');
