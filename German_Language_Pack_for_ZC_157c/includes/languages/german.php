 ...
 * @version $Id: german.php 2021-04-29 Benny Philibel Modified in v1.5.7 $
 */
...
// look in your $PATH_LOCALE/locale directory for available locales..
  $locales = ['de_DE', 'de_DE.utf8', 'de', 'German'];
...
//coupon redeem error messages (checkout payment)
  define('TEXT_COUPON_LINK_TITLE', 'Siehe die Kuponbedingungen');
  define('TEXT_INVALID_REDEEM_COUPON', 'Ungültiger Aktionscode');
  define('TEXT_INVALID_REDEEM_COUPON_MINIMUM', 'Sie müssen mindestens %2$s ausgeben, um den Gutschein "%1$s" einzulösen.');
  define('TEXT_INVALID_COUPON_PRODUCT', 'Dieser Aktionskupon "%1$s" ist für keinen der im Warenkorb befindlichen Artikel gültig');
  define('TEXT_INVALID_COUPON_ORDER_LIMIT', 'Sie haben die Gesamtzahl der zulässigen Bestellungen überschritten (%2$u), um den Gutschein zu verwenden "%1$s".');
  define('TEXT_INVALID_STARTDATE_COUPON', 'Dieser Aktionskupon "%1$s" ist erst nach %2$s gültig. ');
  define('TEXT_INVALID_FINISHDATE_COUPON', 'Dieser Aktionskupon "%1$s" ist abgelaufen (%2$s).');
  define('TEXT_INVALID_USES_COUPON', 'Der Gutschein "%1$s" wurde bereits für die maximal zulässigen Zeiten verwendet (%2$u).');
  define('TEXT_INVALID_USES_USER_COUPON', 'Sie haben den Aktionskupon "%1$s" benutzt. Dieser Aktionskupon hat die maximale Einlöseanzahl pro Kunde erreicht (%2$u).');
  define('TEXT_REMOVE_REDEEM_COUPON_ZONE', 'Der eingegebene Aktionskupon "%s" kann mit der ausgewählten Adresse nicht eingelöst werden.');
...
// cart contents
  ...
  define('ARIA_EDIT_QTY_IN_CART','Menge im Warenkorb bearbeiten');
  define('ARIA_DELETE_ITEM_FROM_CART', 'Diesen Artikel aus dem Warenkorb löschen');
...
// product_listing
  ...
  define('TEXT_PRODUCTS_MIX_OFF_SHOPPING_CART', '<br>*Sie können die Attributmerkmale für diesen Artikel nicht mischen, um die Mindestmengenanforderung zu erfüllen.*<br>');
  define('TEXT_PRODUCTS_MIX_ON_SHOPPING_CART', '*gemischte Attributmerkmale: EIN<br>');

  define('ERROR_MAXIMUM_QTY', 'Die Menge, die Ihrem Warenkorb hinzugefügt wurde, wurde aufgrund einer Beschränkung des zulässigen Höchstbetrags angepasst. Siehe diesen Artikel: <br>');
  define('ERROR_CORRECTIONS_HEADING', 'Bitte korrigieren Sie folgendes: <br>');
  define('ERROR_QUANTITY_ADJUSTED', 'Die Menge, die Ihrem Warenkorb hinzugefügt wurde, wurde angepasst. Der gewünschte Artikel ist nicht in Bruchteilen verfügbar. Die Menge des Artikels: <br>');
...
// shopping cart errors
  ...
  define('OUT_OF_STOCK_CANT_CHECKOUT', 'Produkte gekennzeichnet mit ' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' sind nicht vorrätig oder es ist nicht genügend auf Lager, um Ihre Bestellung auszuführen. <br> Bitte ändern Sie die Menge der mit (' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ') gekennzeichneten Produkte. Vielen Dank.');
  define('OUT_OF_STOCK_CAN_CHECKOUT', 'Produkte gekennzeichnet mit ' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' sind nicht vorrätig.<br>Artikel, die nicht auf Lager sind, werden nachbestellt.');
...
// meta tags special defines
  ...
  define('ASK_A_QUESTION', 'Stellen Sie eine Frage zu diesem Artikel.');
...
// into this message.
//
define('EMP_SHOPPING_FOR_MESSAGE', 'Derzeit für %$1s (%$2s) einkaufen.');

// -----
// Identify the messageStack "severity" to be applied to the above message, one of: "Erfolg",
// "Warnung", "Vorsicht", "Fehler" (standardmäßig "Erfolg").
//
define('EMP_SHOPPING_FOR_MESSAGE_SEVERITY', 'Erfolg');
